...
import { Search, User, BookOpen, Plus, X, Users } from "lucide-react";
import {
  inscribirSocio,
  desinscribirSocio,
...
export default function InscripcionesPage() {
  ...
  const handleInscribir = async (tallerId) => {
    ...
    try {
      ...
      cargarTalleresDeSocio(socioSeleccionado);
    } catch (error) {
  ...
  const handleDesinscribir = async (tallerId) => {
    setProcesando(true);
    try {
      await desinscribirSocio(socioSeleccionado.id, tallerId);
              ...
              <div className="max-h-96 overflow-y-auto space-y-2">
                {sociosFiltrados.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm">No se encontraron socios</p>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{socioSeleccionado.email}</p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="space-y-2">
                        {talleresDelSocio.map((taller) => (
                          ...
                          >
                            ...
                            <button
                              onClick={() => handleDesinscribir(taller.id)}
                              disabled={procesando}
                ...
                <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
                  ...
                  <div className="p-4">
                    {talleresDisponibles.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <BookOpen className="h-10 w-10 text-gray-400 mx-auto mb-2" />
                        <p className="text-gray-500 text-sm">No hay talleres disponibles</p>
                      </div>
                    )}
                  </div>
                </div>
